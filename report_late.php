...
<head>
    <meta charset="UTF-8">
    <title>Attendance Report - Late Students</title>
...
<div class="sam-shell"><div class="sam-page">
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <h3>ðŸ“† Attendance Report - Late Students</h3>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $pdo->prepare("SELECT * FROM student_daily WHERE EDATE = ? AND INTIME > ? AND DEPARTMENT = ? AND AYEAR = ?");
        $stmt->execute([$date, $late_time, $dept, $year]);
        ...
        foreach ($students as $student) {
            ...
            echo "<td class='text-danger'><strong>Late</strong></td>";
            echo "</tr>";
        }
